<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if($medico->getInclusaoEfetuada()) {
            ...
            http://localhost/sis-clinica/index.php?pagina=elenca_medico.php'
            ";
        } else {
            echo '
            <center>
            ...
            <META HTTP-EQUIV=REFRESH CONTENT = '0;URL=
            http://localhost/sis-clinica/index.php?pagina=include_medico.php'
            ";
        }
    }
?>
<div class="container">
    ...
    <form action="index.php?pagina=include_medico.php" method="post">
