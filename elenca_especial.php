                            ...
                            while($linha = mysqli_fetch_array($consulta, MYSQLI_ASSOC)) {
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><a href="index.php?pagina=aggiorna_especial.php&idEspecialidade='.$especialidade->getIdEspecialidade().'"><img src="icones/open-iconic/svg/brush.svg" alt="editar"></a></td>
                                    </tr>
                                </tbody>';
                            }
                            ?>
