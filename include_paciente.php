<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if($paciente->getInclusaoEfetuada()) {
            ...
            http://localhost/sis-clinica/index.php?pagina=elenca_paciente.php'
            ";
        } else {
            echo '
            <center>
            ...
            <META HTTP-EQUIV=REFRESH CONTENT = '0;URL=
            http://localhost/sis-clinica/index.php?pagina=include_paciente.php'
            ";
        }
    }
...
<div class="container">
    ...
    <form action="index.php?pagina=include_paciente.php" method="post">
