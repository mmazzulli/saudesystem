<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if($consulta->getInclusaoEfetuada()) {
            ...
            http://localhost/sis-clinica/index.php?pagina=elenca_consulta.php'
            ";
        } else {
            echo '
            <center>
            ...
            <META HTTP-EQUIV=REFRESH CONTENT = '0;URL=
            http://localhost/sis-clinica/index.php?pagina=appunta_medico.php'
            ";
        }
    }
echo '
<div class="container">
    ...
    <form action="index.php?pagina=appunta_medico.php" method="post">
