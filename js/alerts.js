...
function msgConfirmaDeletePaciente(idPaciente) {
    ...
    if (deletarPaciente) {
        location.href = 'index.php?pagina=elimina_paciente.php&idPaciente=' + idPaciente;
    }
}
...
function msgConfirmaDeleteEspecialidade(idEspecialidade) {
   ...
   if (deletarEspecialidade) {
       location.href = 'index.php?pagina=elimina_especial.php&idEspecialidade=' + idEspecialidade;
   }
}
...
function msgConfirmaDeleteMedico(idMedico) {
   ...
   if (deletarMedico) {
       location.href = 'index.php?pagina=elimina_medico.php&idMedico=' + idMedico;
   }
}
...
function msgConfirmaDeleteConsulta(idConsulta) {
   ...
   if (deletarConsulta) {
       location.href = 'index.php?pagina=elimina_appunta.php&idConsulta=' + idConsulta;
   }
}
