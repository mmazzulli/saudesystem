<?php
    ...
    if (!isset($_POST['pacienteConsulta']) ) {
        $pacienteConsulta = '';
    } else {
        $pacienteConsulta = $_POST['pacienteConsulta'];
    }
    
    if (!isset($_POST['medicoConsulta']) ) {
        $medicoConsulta = '';
    } else {
    ...
    <div class="container">
        ...
        <form action="index.php?pagina=elenca_consulta_personal.php" method="post" style="margin-left: 390px;">
        ...
        <hr/>
        <form action="index.php?pagina=elenca_consulta_personal.php" method="post" style="margin-left: 398px;">
            <div class="form-inline">
                <div class="col-lg-13">
        ...
        <hr/>
        <form action="index.php?pagina=elenca_consulta_personal.php" method="post" style="margin-left: 416px;">
            <div class="form-inline">
                <div class="col-lg-13">
    ...
    if(isset($listar)) {
                                    ...
                                    while($linha = mysqli_fetch_array($listar, MYSQLI_ASSOC)) {
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><a href="index.php?pagina=aggiorna_appunta.php&idConsulta='.$consulta->getIdConsulta().'"><img src="icones/open-iconic/svg/brush.svg" alt="editar"></a></td>
                                            </tr>
                                        </tbody>';
                                    }
                                    echo '
        ...
        echo "Não há ocorrências para esta busca.";
    }
